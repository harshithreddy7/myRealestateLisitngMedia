...
const SaleProperties = () => {
  return (
    ...
    <h2 className="text-4xl font-bold text-gray-800 mb-6">On Sale  <span className="text-green-600">Properties</span></h2>
        ...
        <div className="hover:shadow-md hover:shadow-[#040c16]">
          <div className="bg-white rounded-lg shadow-lg">
            ...
            <div className="py-6 px-4">
              ...
              <button className="mt-6 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-amber-700">
                View Details
              </button>
            </div>
          </div>
