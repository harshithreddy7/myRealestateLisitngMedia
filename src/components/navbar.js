  ...
  return (
    <div className={`fixed top-0 z-50 w-full h-[70px] flex justify-between items-center px-4 text-black ${isScrolled ? "bg-white" : "bg-transparent"}`} >
      ...
      <div className="hidden md:flex">
        ...
        <button className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-amber-900 hover:text-white mx-2">
      ...
      <div
        ...
        } md:hidden flex flex-col bg-green-600 text-white w-full absolute top-16 left-0 z-10`}
      >
        <Link
          to="home"
          smooth={true}
